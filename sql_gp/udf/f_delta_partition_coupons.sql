CREATE OR REPLACE FUNCTION std12_116_pr.f_delta_partition_coupons(p_table_from text, p_file_name  text,     p_table_to text, p_partition_key text,
...
begin
	...
	v_end_date := date_trunc('month', p_end_date );
        ...
        SELECT std12_116_pr.f_create_temp_table_coupons(
            p_table_from,
            p_file_name,
            p_partition_key,
            v_start_date::timestamp,
...
-- std12_116_pr.f_create_temp_table_coupons( p_table text, p_file_name text,
